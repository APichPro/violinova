...
import AudioControls from '@/components/ui/audioPlayer/AudioControls';
import TrackBar from '@/components/ui/audioPlayer/TrackBar';
import Image from 'next/image';
import volumeSVG from '@/public/icons/volume.svg';
import muteSVG from '@/public/icons/mute.svg';
import repeatSVG from '@/public/icons/repeat.svg';
import repeatOneSVG from '@/public/icons/repeat-one.svg';
import Timer from '@/components/ui/audioPlayer/Timer';
...
> = ({
  ...
  return (
    <div
      className={`w-full h-max flex gap-[10px] flex-col items-center relative`}
    >
      <div className={`flex items-center justify-evenly w-full gap-[10px]`}>
        {minimal ? (
          <AudioControls
            isPlaying={isPlaying}
            allowSkip={false}
        ...
        <div
          className={`grid grid-cols-1 grid-rows-1 w-full h-[${trackHeight}px]`}
        >
          {visualise && blob && (
            <AudioVisualizer
              width={width}
      ...
      {!minimal && (
        <div className="grid grid-cols-3	place-items-center width-[98%]">
          {showLoopOption && (
            <Image
          ...
          />
          {showVolumeControl && (
            <div className="flex gap-2 justify-self-end w-[80px]">
              <Image
